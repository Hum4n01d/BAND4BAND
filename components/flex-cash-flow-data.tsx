            ...
            step.outflows.forEach((outflow) => {
              if (Math.random() < 0.4) {
                ...
                if (stepElement && breakdownElements.length > 0) {
                  ...
                  let speed = 0.02;
                  if (outflow.value > 1000)
                    speed = Math.min(0.08, 0.02 + outflow.value / 10000);
  ...
  return (
    <div className="h-full w-full flex flex-col">
      ...
      <div className="flex-1 relative overflow-auto" ref={containerRef}>
        ...
        <div className="flex items-start justify-start min-w-max h-full py-8">
                ...
                >
                  ...
                  {step.outflows.length > 0 && (
                    <div className="flex flex-col h-full">
                      {(() => {
                        const investments = step.outflows.filter(
                          (o) => o.type === "investment"
                        );
                        const spending = step.outflows.filter(
                          (o) => o.type === "spend"
                        );
                                    ...
                                    {Object.entries(outflow.breakdown).map(
                                      (
                                        ...
                                        return (
                                          <div
                                            className="flex items-center"
                                            key={`breakdown-investment-${stepIndex}-${outflowIndex}-${breakdownIndex}`}
                                          >
                                            <div
                                  ...
                                  {Object.entries(outflow.breakdown).map(
                                    (
                                      ...
                                      return (
                                        <div
                                          className="flex items-center"
                                          key={`breakdown-spend-${stepIndex}-${outflowIndex}-${breakdownIndex}`}
                                        >
                                          <div
